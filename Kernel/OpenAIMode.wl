...
BeginPackage["AntonAntonov`OpenAIMode`"];
...
OpenAIModeCellIcon::usage = "OpenAIMode cell icon.";

PacletInstall["ChristopherWolfram/OpenAILink", AllowVersionUpdate -> False];
...
Clear[OpenAIModeCellIcon];
OpenAIModeCellIcon[] := rbOpenAI;
